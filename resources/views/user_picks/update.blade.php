                        ...
                        <table class="table">
                            ...
                            @if($saturday_early_count>0 || $saturday_early_count !="")
                                ...
                                @foreach($saturday_early as $saturdayearly)
                                    @if($saturdayearly->locked != '1')
                                        ...
                                        <tr>
                                            <form action="{{ route('user.pick.update', ['id' => $saturdayearly->id]) }}" method="post" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                            <td><input type="radio" name="options" id="options1" value="f" @if ($saturdayearly->pick=='f') checked @endif> @if ($saturdayearly->home_team=='f') <span class="glyphicon glyphicon-home"></span> @endif{{ $saturdayearly->master_favorit }} @if($saturdayearly->home_team !='none') <font color="red"> <b>-@endif @if($saturdayearly->master_spread != '0'){{$saturdayearly->master_spread}}@endif</b></font></td>
                                            <td><input type="radio" name="options" id="options2" value="u" @if ($saturdayearly->pick=='u') checked @endif> @if ($saturdayearly->home_team=='u') <span class="glyphicon glyphicon-home"></span> @endif{{ $saturdayearly->master_underdog}} @if($saturdayearly->home_team !='none') <font color="green"> <b>+@endif @if($saturdayearly->master_spread != '0'){{$saturdayearly->master_spread}} @endif</b></font></td>
                                    ...
                                    <tr>
                                        <td>@if($saturdayearly->pick == 'f')<font color="green"> <span class="glyphicon glyphicon-check"></span></font>@endif  @if ($saturdayearly->home_team=='f') <span class="glyphicon glyphicon-home"></span> @endif  {{ $saturdayearly->master_favorit }} @if($saturdayearly->home_team !='none')<font color="red"> <b>-@endif @if($saturdayearly->master_spread != '0'){{$saturdayearly->master_spread}} @endif</b></font></td>
                                        <td>@if($saturdayearly->pick == 'u')<font color="green"><span class="glyphicon glyphicon-check"></span></font>@endif  @if ($saturdayearly->home_team=='u') <span class="glyphicon glyphicon-home"></span> @endif{{ $saturdayearly->master_underdog}} @if($saturdayearly->home_team !='none') <font color="green"> <b>+@endif @if($saturdayearly->master_spread != '0') {{$saturdayearly->master_spread}} @endif</b></font></td>
...
<!-- Saturday Late -->
                            ...
                            @if($saturday_late_count>0)
                                ...
                                @foreach($saturday_late as $saturdaylate)
                                    @if($saturdaylate->locked != '1')
                                        ...
                                        <tr>
                                            <form action="{{ route('user.pick.update', ['id' => $saturdaylate->id]) }}" method="post" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                            <td><input type="radio" name="options" id="options1" value="f" @if ($saturdaylate->pick=='f') checked @endif>  @if ($saturdaylate->home_team=='f') <span class="glyphicon glyphicon-home"></span> @endif{{ $saturdaylate->master_favorit }} @if($saturdaylate->home_team !='none') <font color="red"> <b>- @endif @if($saturdaylate->master_spread != '0'){{$saturdaylate->master_spread}} @endif</b></font></td>
                                            <td><input type="radio" name="options" id="options2" value="u" @if ($saturdaylate->pick=='u') checked @endif>  @if ($saturdaylate->home_team=='u') <span class="glyphicon glyphicon-home"></span> @endif{{ $saturdaylate->master_underdog}} @if($saturdaylate->home_team !='none') <font color="green"> <b>+ @endif @if($saturdaylate->master_spread != '0'){{$saturdaylate->master_spread}} @endif</b></font></td>
                                            <td><button class="btn btn-sm btn-success" type="submit">
                                                    Update Pick
                                                </button>
                                            </td>
                                    ...
                                    <tr>
                                        <td>@if($saturdaylate->pick == 'f')<font color="green"> <span class="glyphicon glyphicon-check"></span></font>@endif  @if ($saturdaylate->home_team=='f') <span class="glyphicon glyphicon-home"></span> @endif{{ $saturdaylate->master_favorit }} @if($saturdaylate->home_team !='none') <font color="red"> <b>- @endif @if($saturdaylate->master_spread != '0'){{$saturdaylate->master_spread}} @endif</b></font></td>
                                        <td>@if($saturdaylate->pick == 'u')<font color="green"><span class="glyphicon glyphicon-check"></span></font>@endif  @if ($saturdaylate->home_team=='u') <span class="glyphicon glyphicon-home"></span> @endif{{ $saturdaylate->master_underdog}} @if($saturdaylate->home_team !='none') <font color="green"> <b>+ @endif @if($saturdaylate->master_spread != '0'){{$saturdaylate->master_spread}} @endif</b></font></td>
...
<!-- Saturday Night -->
                            ...
                            @if($saturday_night_count>0)
                                ...
                                @foreach($saturday_night as $saturdaynight)
                                    @if($saturdaynight->locked != '1')
                                        ...
                                        <tr>
                                            <form action="{{ route('user.pick.update', ['id' => $saturdaynight->id]) }}" method="post" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                            <td><input type="radio" name="options" id="options1" value="f" @if ($saturdaynight->pick=='f') checked @endif> @if ($saturdaynight->home_team=='f') <span class="glyphicon glyphicon-home"></span> @endif{{ $saturdaynight->master_favorit }} @if($saturdaynight->home_team !='none') <font color="red"> <b>- @endif @if($saturdaynight->master_spread != '0'){{$saturdaynight->master_spread}} @endif</b></font></td>
                                            <td><input type="radio" name="options" id="options2" value="u" @if ($saturdaynight->pick=='u') checked @endif>  @if ($saturdaynight->home_team=='u') <span class="glyphicon glyphicon-home"></span> @endif{{ $saturdaynight->master_underdog}} @if($saturdaynight->home_team !='none') <font color="green"> <b>+ @endif @if($saturdaynight->master_spread != '0'){{$saturdaynight->master_spread}} @endif</b></font></td>
                                            <td><button class="btn btn-sm btn-success" type="submit">
                                                    Update Pick
                                                </button>
                                            </td>
                                    ...
                                    <tr>
                                        <td>@if($saturdaynight->pick == 'f')<font color="green"> <span class="glyphicon glyphicon-check"></span></font>@endif  @if ($saturdaynight->home_team=='f') <span class="glyphicon glyphicon-home"></span> @endif{{ $saturdaynight->master_favorit }} @if($saturdaynight->home_team !='none') <font color="red"> <b>- @endif @if($saturdaynight->master_spread != '0'){{$saturdaynight->master_spread}} @endif</b></font></td>
                                        <td>@if($saturdaynight->pick == 'u')<font color="green"><span class="glyphicon glyphicon-check"></span></font>@endif  @if ($saturdaynight->home_team=='u') <span class="glyphicon glyphicon-home"></span> @endif{{ $saturdaynight->master_underdog}} @if($saturdaynight->home_team !='none') <font color="green"> <b>+ @endif @if($saturdaynight->master_spread != '0'){{$saturdaynight->master_spread}} @endif</b></font></td>
                                ...
                                @foreach($sunday_night as $sundaynight)
                                    ...
                                    @if($sundaynight->locked == '1')
                                        ...
                                        <tr>
                                            ...
                                            <td>@if($sundaynight->pick == 'u')<font color="green"><span class="glyphicon glyphicon-check"></span></font>@endif  @if ($sundaynight->home_team=='u') <span class="glyphicon glyphicon-home"></span> @endif{{ $sundaynight->master_underdog}} @if($sundaynight->home_team !='none') <font color="green"> <b>+@endif @if($sundaynight->master_spread != '0'){{$sundaynight->master_spread}} @endif</b></font></td>
...
<!-- Super Bowl -->
                            ...
                            @if($super_bowl_count>0)
                                ...
                                @foreach($super_bowl as $superbowl)
                                    @if($superbowl->locked != '1')
                                        <tr>
                                            <form action="{{ route('user.pick.update', ['id' => $superbowl->id]) }}" method="post" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                            <td><input type="radio" name="options" id="options1" value="f" @if ($superbowl->pick=='f') checked @endif> @if ($superbowl->home_team=='f') <span class="glyphicon glyphicon-home"></span> @endif{{ $superbowl->master_favorit }} @if($superbowl->home_team !='none')<font color="red"> <b>-@endif{{$superbowl->master_spread}}</b></font></td>
                                            <td><input type="radio" name="options" id="options2" value="u" @if ($superbowl->pick=='u') checked @endif>  @if ($superbowl->home_team=='u') <span class="glyphicon glyphicon-home"></span> @endif{{ $superbowl->master_underdog}} @if($superbowl->home_team !='none')<font color="green"> <b>+@endif{{$superbowl->master_spread}}</b></font></td>
                                            <td><button class="btn btn-sm btn-success" type="submit">
                                                    Update Pick
                                                </button>
                                            </td>
                                    ...
                                    @if($superbowl->locked == '1')
                                    <tr>
                                        <td>@if($superbowl->pick == 'f')<font color="green"> <span class="glyphicon glyphicon-check"></span></font>@endif  @if ($superbowl->home_team=='f') <span class="glyphicon glyphicon-home"></span> @endif{{ $superbowl->master_favorit }} @if($superbowl->home_team !='none')<font color="red"> <b>-@endif{{$superbowl->master_spread}}</b></font></td>
                                        <td>@if($superbowl->pick == 'u')<font color="green"><span class="glyphicon glyphicon-check"></span></font>@endif  @if ($superbowl->home_team=='u') <span class="glyphicon glyphicon-home"></span> @endif{{ $superbowl->master_underdog}} @if($superbowl->home_team !='none')<font color="green"> <b>+@endif{{$superbowl->master_spread}}</b></font></td>
